...
/**
 * A true {@link ArrayList} adapter providing access to all ArrayList methods. Also implements {@link Swappable} for
 * easy item swapping.
 */
public abstract class ArrayAdapter<T> extends BaseAdapter implements DynamicListView.Swappable {
	...
	/**
	 * Creates a new {@link ArrayAdapter} with a <b>copy</b> of the specified list, or an empty list if items == null.
	 */
	...
	/**
	 * Appends all of the elements in the specified collection to the end of the list, in the order that they are
	...
	/**
	 * Returns the position of the first occurrence of the specified element in this list, or -1 if this list does not
	 * contain the element. More formally, returns the lowest position <tt>i</tt> such that
	 * <tt>(o==null&nbsp;?&nbsp;get(i)==null&nbsp;:&nbsp;o.equals(get(i)))</tt>, or -1 if there is no such position.
	 */
